            ...
            <td class="container">
                <div class="content">
                    ...
                    <table class="main">
                        ...
                        <tr>
                            <td class="wrapper">
                                <table border="0" cellpadding="0" cellspacing="0" style="box-sizing: border-box; width: 100%;" class="btn btn-primary">
                                    <tbody>
                                        <tr>
                                            <td>
                                                <h1 style="background-color: #5bc0de; border: solid 2px #ffffff; -moz-border-radius: 5px; -webkit-border-radius: 5px; border-radius: 5px; box-sizing: border-box; color: #ffffff; font-size: 14px; font-weight: bold; margin: 0; padding: 12px 25px; text-decoration: none; text-transform: capitalize">Job Status Notification</h1></td>
                                        </tr>
                                    </tbody>
                                </table>
                                <br>
                                <table border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            <p style="font-family: 'Source Sans Pro', sans-serif; font-size: 16px;text-align: justify;text-justify: inter-word;">Hi Team,</p> The below report shows the job metrics information.
                                            <p style="text-align:center;"><b>Job Metrics:</b></p>
                                            <table border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                    ...
                    <div class="footer">
                        <table border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td class="content-block powered-by">Powered by AIT</td>
                            </tr>
                        </table>
                    </div>
                    <!-- END FOOTER -->
...
def getNewSpiderModule():
    import os
    BASE_DIR = os.path.dirname(os.path.dirname(__file__))
    SPIDER_DIR = os.path.join(BASE_DIR, "Data_scuff", "spiders")
    m = ['Data_scuff.spiders.{}'.format(x)
        for x in os.listdir(SPIDER_DIR) 
       if os.path.isdir(os.path.join(SPIDER_DIR, x)) and not x.startswith('.') 
       and not x.startswith('__pycache')]
    m.insert(0, 'Data_scuff.spiders')
    return m


def getDriverPath(driverpath, driver):
    import os
    return os.path.join(os.path.dirname(os.path.dirname(__file__)),
                        'Data_scuff', 'configs', 'External-Dependency', driverpath, driver)


def gettesseractPath():
    import os
    return os.path.join(os.path.dirname(os.path.dirname(__file__)),
                        'Data_scuff', 'configs', 'External-Dependency', 'tesseract-setup', 'tesseract-ocr-setup-3.02.02.exe')

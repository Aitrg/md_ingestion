...
class WaWhatcomBellinghamBuildingPermitsSpider(CommonSpider):
    name = '973_wa_whatcom_bellingham_building_permits'
    allowed_domains = ['cob.org']
    start_urls = ['https://www.cob.org/epermits/Search/permit.aspx']
    custom_settings = {
        'FILE_NAME':Utils.getRundateFileName('AI-973_Permits_Buildings_WA_Whatcom_Bellingham_CurationReady'),
        'JIRA_ID':'AI_973',
        'DOWNLOAD_DELAY':5,
    ...
    check_first = True
    end_date=''
    SearchCriteria=['BAN', 'BLD', 'CCI', 'CLR', 'CMB', 'CON', 'DEM', 'ELB', 'ELE', 'FAP', 'FCP', 'FHP', 'FLP', 'FPP', 'FSP', 'GRD', 'LUA', 'LUH', 'MEC', 'MPR', 'OCC', 'PBW', 'PLM', 'SGN', 'SPI', 'STM', 'STP', 'STR', 'TMP', 'UFC', 'WQP']

...
class IlHospitalLicensesSpider(ExcelFeedSpider,DataFormatterMixin,LookupDatareaderMixin):
    name = '1390_il_renal_desease_facility_licenses'
    ...
    custom_settings = {
        'FILE_NAME':Utils.getRundateFileName('AI-1390_Licenses_Renal_Desease_Facility_IL_CurationReady'),
        'JIRA_ID':'AI_1390',
        'DOWNLOAD_DELAY':5,
    ...
    def parse(self, response):
        url='https://data.illinois.gov/dataset/715197b3-bc4f-4d5f-8ca9-1cab6427f137/resource/818ea02b-70f3-4431-9bdb-2087fb645ee0/download/siqueryinterns-2018-2019illinois.govend-stage-renal-disease-march-2019.xls'
